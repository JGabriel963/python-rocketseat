...
from src.models.redis.interfaces.redis_repository import RedisRepositoryInterface
from src.models.sqlite.interfaces.products_repository import ProductsRepositoryInterface
...
class ProductFinder:
    ...
    def __find_in_cache(self, product_name: str) -> tuple | None:
